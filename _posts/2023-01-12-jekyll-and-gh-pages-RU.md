...
Скрипт получается очень простым, поэтому я решил не подключать чужой, и написал свой. Посмотреть его можно здесь: [headers.js](https://github.com/flametaichou/flametaichou.github.io/blob/main/assets/js/headers.js)
